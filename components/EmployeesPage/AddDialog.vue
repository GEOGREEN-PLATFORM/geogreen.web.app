    ...
    <div class="employee-add-dialog__container">
      ...
      <q-form ref="formRef" novalidate greedy class="employee-add-dialog__form" @submit="onSubmit">
        ...
        <footer class="employee-add-dialog__footer">
          <GGButton design-type="tertiary" :label="cancelLabel" @click="onBack" />
...
const { formRef, formHasError } = useFormValidation();
...
function generatePassword(): string {
  ...
  passwordArr[index] = specialChars[Math.floor(Math.random() * specialChars.length)];
