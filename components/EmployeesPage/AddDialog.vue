    ...
    <GGDialog v-model="dialogVisible" class="employee-add-dialog">
      <div class="employee-add-dialog__container">
        ...
        <q-form
          ...
          novalidate
          greedy
          class="employee-add-dialog__form"
          @submit="onSubmit"
        >
          ...
          <template v-else-if="currentStep === 2">
            <section class="employee-add-dialog__section">
              ...
              <div class="employee-add-dialog__info-row gg-t-base">
                ...
                <span class="employee-add-dialog__info-value">{{ form.personalData.dateOfBirth }}</span>
              </div>
            </section>
            <section class="employee-add-dialog__section">
              <h2 class="employee-add-dialog__section-title gg-h3">Контакты</h2>
              ...
              <div class="employee-add-dialog__password-container">
                ...
                <div class="employee-add-dialog__password-wrapper">
                  ...
                  <div
                    ...
                    @click="copyPassword"
                    >
                    <q-icon :class="{'pop-animation': isAnimating}" :name="mdiContentCopy" size="32px" class="employee-add-dialog__copy-icon" />
                    <span :style="`opacity: ${Number(showTooltip)}`" class="employee-add-dialog__copy-tooltip">{{ tooltipText }}</span>
                </div>
                </div>
              </div>
            </section>
