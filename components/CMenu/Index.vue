<template>
  <div class="c-menu-container">
    <div class="toolbar-left gg-logo">
      <NuxtImg class="gg-logo__image" src="/icons/gg_logo.jpg" width="32px" />
      ...
      <div
        ...
        @click="toggleMenu"
      >
        <div v-for="bar in 3" :key="bar" class="bar" />
      </div>
    </div>
    <div class="toolbar-right">
      ...
      <div class="login-buttons">
        <GGButton label="Войти" strech="hug" size="small" @click="navigateTo('/auth/login')" />
        <GGButton
          label="Регистрация"
          strech="hug"
    ...
    <Transition name="slide-left">
      <div v-show="isMobileMenuOpened" class="c-menu-container__mobile">
        <div class="menu-top">
          ...
          <q-icon :name="mdiCog" color="grey-500" size="32px" />
        </div>
